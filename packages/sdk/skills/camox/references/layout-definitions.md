...
A curated layout (`kind: "curated"`, the default) defines a reusable shell and its before/after blocks for editor-created pages, which choose their URLs and have page-content `children`.

For code-owned singleton pages or data-driven derived routes, read [Routed layouts](routed-layouts.md) instead. This reference covers curated layouts.
